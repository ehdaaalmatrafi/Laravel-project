...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Wadi Makkah Venture</title>
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center bg-center selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('user/profile') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">profile</a>
                    @else
          ...
          <div class="navbar">
              ...
              <nav>
                  <ul>
                    ...
                    <li><a href="http://127.0.0.1:8002/arabic">عربي</a></li>
  </ul>
              </nav>  
            </div>
        </div>
        ...
        <div class="title">
              <h1>Welcome to Wadi Makkah Venture</h1>
                <p> WMV is constantly looking to invest in early stage startups
                 within Hajj and Umrah HiTech and Creative industries. </p>
                 <h2> <br> Venture Capital</h2>
            </div>
            <div class="button">
            <a href="#" class="btn1">Apply Now</a>

            <a href="#" class="btn2">Manage Scores </a> 
        </div>
        <div id="focus" class="focus">
                        <h2> VC Focus</h2>
                        <div class="kaaba"> <label><img src="https://www.wmvc.sa/image/icons/kaaba.png?v=3" id="kaabaimg" ></label> <p><b>We invest in Everything Tech that contributes to the Hajj Umrah ecosystem</b></p> </div> 
...
<div class="image-container">
  <div class="image-wrapper">
    ...
    <div class="image-caption"> <b>Edtech</b> </div>
  </div>
  <div class="image-wrapper">
    <img src="/img/ايقونات الاستثمار-04.png" alt="Image 2">
    <div class="image-caption"> <b> AI&IoT </b></div>
  </div>
  <div class="image-wrapper">
    <img src="/img/ايقونات الاستثمار-05-01.png" alt="Image 3">
    <div class="image-caption"> <b> Health tech </b> </div>
  </div>
  <div class="image-wrapper">
    <img src="/img/ايقونات الاستثمار-05-02.png" alt="Image 4">
    <div class="image-caption"> <b> Media&Advertising </b> </div>
 </div>
 <div class="image-wrapper">
    <img src="/img/ايقونات الاستثمار-12.png" alt="Image 5">
    <div class="image-caption"> <b> Entertainment </b> </div>
</div>
...
<div class="image-wrapper2">
    ...
    <div class="image-caption2"> <b> Hospitality&tourism </b> </div>
</div>
<div class="image-wrapper2">
    <img src="/img/ايقونات الاستثمار-02.png" alt="Image 7">
    <div class="image-caption2"> <b> Agritech </b> </div>
</div>
<div class="image-wrapper2">
    <img src="/img/ايقونات الاستثمار-08.png" alt="Image 8">
    <div class="image-caption2"> <b> Legaltech
 </b> </div>
</div>
<div class="image-wrapper2">
    <img src="/img/ايقونات الاستثمار-09.png" alt="Image 9">
    <div class="image-caption2"> <b> Smart cities </b> </div>
</div>
<div class="image-wrapper2">
    <img src="/img/ايقونات الاستثمار-10.png" alt="Image 10">
    <div class="image-caption2"> <b> Digital markets </b> </div>
</div>
            </div>

            <div id="Fund" class="Fund">
           <h2> Fund Portfolio </h2>
          <!-- <hr size="8" width="80%" > -->
...
<h2> Is the first fund established by Wadi Makkah Ventures Co. on 2015. The fund portfolio holds a number of successful startup investments. It was closed in 2017. Three of the fund holdings have managed to secure second rounds of investments. </h2>
<div class="line2"></div>
 ...
 <div id="Fund2" class="Fund2">
              ...
              <h2> Was established by the Board of Directors' resolution on Dec 2018 for the purpose of investing in a seed, and early stage startups "incubated startups". The fund holds selected investment from the incubator program 2018 co-horts. </h2>
...
<div class="image-container-Directory">
  <div class="image-wrapper-Directory">
    ...
    <div class="image-caption-Directory"> <b> Fund Manager</b></div>
  </div>
  <div class="image-wrapper-Directory">
    <img src="/img/reyl.png" height="100" width="250" alt="Image 3">
    <div class="image-caption-Directory" > <b> Investment Advisor</b> </div>
  </div>

  <div class="image-wrapper-Directory">
    <img src="/img/pwc.png"  height="0" width="250" alt="Image 4">
    <div class="image-caption-Directory"> <b> Fund Tax Advisor </b> </div>
 </div>
...
<div class="image-container-dif">
  ...
  <h2>Financial Support <br>and Investment</h2>
  <p>Wadi Makkah Venture motivates incubated startups by providing support and seed funds.</p></p>

</div>
<div class="image-container-dif">
  <img src="/img/legal.png" alt="Image 2">
  <h2>Legal consultations
</h2>
  <p>Wadi Makkah Venture employs specialized business attorneys to provide vital assistance to entrepreneurs.</p>
</div>
<div class="image-container-dif">
  <img src="/img/networking.png" alt="Image 3">
  <h2>Networking
</h2>
  <p>Wadi Makkah hires technical experts who are ready to provide entrepreneurs with professional consultation to ensure high-quality products.</p>
</div>
 </div> 
...
<div id="DealFlow" class="DealFlow">
    ...
    @foreach($DealFlow as $Deal)
      ...
      <li> LPKF D104 PCB milling Machine to produce 4 layers Printed Circuit Boards (PCB)</li>
        <li>Cut, Engrave and Print on different types of materials with the help of Trotec Speedy 400 Flexx Laser 
        </li>
        <li>Cut, Engrave and Print on different types of materials with the help of Trotec Speedy 400 Flexx Laser 
        </li>
